                      ...
                      <table _a584de>
                          ...
                          <tbody>
                            <template v-for="(product, sl) in cart">
                              <tr v-if="product.serial.length > 140">
                                  <td>{{ sl + 1 }}</td>
                                  <td v-if="product.serial.length > 0">{{ product.Product_Name }} <br>
                                  ({{ product.serial.slice(0,140).map(obj => obj.ps_imei_number).join(', ') }}
                                  </td>
                              ...
                              <tr v-if="product.serial.length > 140">
                                  <td></td>
                                  <td>{{ product.serial.slice(141,10000).map(obj => obj.ps_imei_number).join(', ') }})
                                  </td>
                                  <td></td>
                                  <td></td>
                                  <td></td>
